...
shoeName:Yup.string().min(3).max(200).required("ShoeName is required"),
shoeDescription:Yup.string().min(5).max(255).required("Shoe Description is required"),
shoeBrand:Yup.string().min(1).max(50).required("Shoe Brand is required"),
...
shoeType:Yup.string().required("shoe type is requried")
