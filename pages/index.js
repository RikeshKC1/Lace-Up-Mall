...
function Signup() {
 ...
 const {values,errors,handleBlur,handleChange,handleSubmit,touched}= useFormik({
  ...
  return (
    ...
    <div className='col-sm-6 d-flex justify-content-center align-items-center'>Already have an Account?<button className='btn'><Link passHref legacyBehavior href='/normal/login'><a className='text-decoration-none'> Login</a></Link></button></div>
    </div>
